...
EOF`.split('\n')
      ...
      expect(entities[0].extensions).toMatchObject({
        ACAD_REACTORS: [{ code: 330, value: 'soft-id' }],
        ACAD_XDICTIONARY: [{ code: 360, value: 'hard-id' }],
        FOO: [{ code: 2, value: 'bar' }],
      })
    })
  })
  ...
  test('tc0', () => {
    ...
    expect(entities[0]).toMatchObject({
      proxyByte: 254,
      proxyEntity:
        '',
    })
  })
})
